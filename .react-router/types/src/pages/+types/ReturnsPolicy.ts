...
type Module = typeof import("../ReturnsPolicy.js")

type Info = GetInfo<{
  file: "pages/ReturnsPolicy.tsx",
  module: Module
}>
...
type Matches = [{
  ...
  module: typeof import("../../components/layout/Layout.js");
}, {
  id: "pages/ReturnsPolicy";
  module: typeof import("../ReturnsPolicy.js");
}];
